    ...
    <div className="page-wrap">
      <section className="header-section">
        ...
        <p className="header-description">
          Dreams within dreams, ideas within ideas. Discover infinite layers of
          possibility.
        </p>
        ...
        <div className="card-row">
          <section className="card">
            <div>
              ...
              <p className="card-description">
                Each interaction reveals deeper functionality, like opening a
                matryoshka doll of digital experiences.
              </p>
            </div>
          </section>
          ...
          <section className="card">
            <div>
              ...
              <p className="card-description">
                Navigate through a world of curated products that react to your
                curiosity.
              </p>
            </div>
          </section>
          ...
          <section className="card">
            <div>
              ...
              <p className="card-description">
                Each visit reveals something new. Keep peeling back the layers
                to uncover more.
              </p>
            </div>
          </section>
